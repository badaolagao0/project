...
<head>
    ...
    <!-- C:\wamp\www\CuaHangSach\css\styleIndex.css -->
...
<body>
    ...
    <!-- Slide-Banner -->
    <div class="container width-80" style="margin-top:10px">
    ...
    <!--Nội dụng phần body  -->
    <div class="container width-80 p-3 border border-0 bg-color-green" id="sanpham" style="margin-top: 10px">
        <center><b>
                <span style="padding: 0 12px; font-size: 26px; color: black">SẢN PHẨM</span></b>
        </center>
