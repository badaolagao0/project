...
<body>
    ...
    <!--Nội dụng phần body  -->
    <div class="container width-80 p-2 border border-0 bg-color mt-5" style="border-radius: 20px">
    ...
    <div class="container width-80 p-3 border border-0 bg-color mt-2"
        style="border-radius: 20px; margin-bottom: 150px !important">
        <?php
            include_once("View/vCart.php");
        ?>
    </div>
    <div class="container-fluid position-fixed bottom-0 py-2"
