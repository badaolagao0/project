    ...
    <div class="container py-3">
        <div class="row align-items-center">
            ...
            <div class="col-lg-2 col-md-2 re-767 text-header">
                <a href="indexKh.php" class="hov">Trang chủ</a>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-5 col-5">
                <form class="d-flex sua-tim-kiem">
                    <input class="form-control rounded-pill" disabled type="search"
                        style="width:100%;padding-right: 13%;" placeholder="Search" aria-label="Search"
                        style="width:500px">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-2">
                <div class="container-fluid px-0">
                    <div class="row flex-column">
                        ...
                        <a href="#" class="text-center text-header hov"
